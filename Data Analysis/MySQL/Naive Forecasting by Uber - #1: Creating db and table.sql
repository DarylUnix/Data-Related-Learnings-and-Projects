DROP DATABASE IF EXISTS `Naive_Forecasting`;
CREATE DATABASE `Naive_Forecasting`;
USE `Naive_Forecasting`;
...
INSERT INTO uber_request_logs (request_id, request_date, request_status, distance_to_travel, monetary_cost, driver_to_client_distance)
VALUES
